package com.example.bandoo.ui.message_recycler_view.view_holders
...
import com.example.bandoo.database.getFileFromStorage
import com.example.bandoo.ui.message_recycler_view.views.MessageView
...
class HolderFileMessage(view: View) : RecyclerView.ViewHolder(view), MessageHolder {
    ...
    private val chatUserBtnDownload:ImageView = view.chat_user_btn_file
    ...
    private val chatReceivedBtnDownload:ImageView = view.chat_user_btn_file
